    ...
    >
      ...
      {variant === 'services' && (
        <div className="absolute inset-0">
          <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-blue-gray/30 to-transparent"></div>
          <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-gray-900/70 to-transparent"></div>
        </div>
      )}
      
      {variant === 'projects' && (
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-b from-gray-900/70 to-transparent"></div>
          <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-gray-900/70 to-transparent"></div>
        </div>
      )}
